...
from contect.available.available import AvailableSelections, AvailableAggregators
...
CSV_ATTRIBUTES_FST = [AvailableSelections.ACTIVITY.value.title(), TIMESTAMP.title(), OBJECTS.title(), VALUES.title()]
CSV_ATTRIBUTES_SND = [AvailableSelections.RESOURCE.value.title(), AvailableSelections.LOCATION.value.title()]
...
RESULT_INIT_SUMMARY = 'result-init-summary'  # Used as the id of a jobs store for summary details tasks
RESULT_POST = 'result-post'  # Used as the id of a jobs store for post-processing tasks and as an id for a global signal
# telling whether the current job has a valid post-processing task
RESULT_RECOMPUTE = 'result-recompute'  # Used as the id of a global signal that tells whether a new dev ctx config
...
STORES_SIGNALS = [CORR_TITLE, CORR_OUT_TITLE, TRACE_TITLE, DEV_CTX_TITLE, RESULT_TITLE, GUIDANCE_TITLE, RESULT_INIT,
                  RESULT_POST, RESULT_INIT_SUMMARY]
TYPED_STORES_SIGNALS = [TRACE_TITLE, DEV_CTX_TITLE]
GLOBAL_FORM_SIGNAL = 'current-log'
FORMS = [PARSE_TITLE, CORR_TITLE, CORR_OUT_TITLE, DEV_CTX_TITLE, RESULT_TITLE, TRACE_TITLE]
MULTI_PAGE_URLS = [CORR_OUT_TITLE, RESULT_TITLE, TRACE_RESULT_SIGNAL, TRACE_RETURN]
...
INTRINSIC_DEVIATION = 'process deviations'
EXTERNAL_DEVIATION = 'context deviations'
